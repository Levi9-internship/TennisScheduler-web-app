    ...
    return (
        <div className="auth-form-container">
            ...
            <form onSubmit={registrationSubmit} className="register-form">
                ...
                <input type="text" value={formValues.name} onChange={handleChange} placeholder="John" id="name" name="name" />
                <p className="errors"> {formErrors.name}</p>
                <label htmlFor="surname"> Your surname</label>
                <input type="text" value={formValues.surname} onChange={handleChange} placeholder="Marks" id="surname" name="surname" />
            ...
            <Link to="/login" > <button className="link-button">Already have an account? Log in here. </button></Link>
        </div>
    )
}